	...
	public static void main(String[] args) {
		...
		Scanner s=new Scanner(System.in);
         ...
         case 5:
        	 ...
        	 new Validationemail().checkpassword();
        	 break;


         case 6 :
        	 new Validationemail().FirstLamda();
        	 break;

         case 7 :
        	 new Validationemail().LastLamda();
        	 break;

         case 8:
        	 new Validationemail().PhoneLamda();
        	 break;
         case 9 :
         ...
         case 10 :
             new Validationemail().PasswordLamda();
        	 break;
